    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6" >
                {{-- <button class="text-[#008CFF] dark:text-[#08C68D] hover:bg-gray-400 rounded-full p-2">
                ...
                <div class="ms-3 relative ">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger" >
                            ...
                            <span class="inline-flex rounded-md">
                                <button type="button"
                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-[#008CFF] bg-white hover:text-gray-700 focus:outline-none focus:bg-[#008CFF] focus:text-white active:bg-[#008CFF]   dark:bg-[#11151A] hover:dark:text-[#11151A] hover:dark:bg-[#08C68D] dark:text-[#08C68D] focus:dark:bg-[#08C68D] focus:dark:text-[#11151A]  active:dark:bg-[#08C68D] transition ease-in-out duration-150 ">
                                    {{-- {{ Auth::user()->name }} --}}
                        ...
                        <x-slot name="content" >
                            <!-- Account Management -->
                            <div class=" block px-4 py-2 text-xs text-gray-400 dark:text-[#08C68D]">
                                {{ __('Manage Account') }}
                            </div>
